package com.axway.presales.borrower.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("BorrowerApp");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("BorrowerApp");
        ...
        config.getMapConfigs().put("com.axway.presales.borrower.domain.*", initializeDomainMapConfig(jHipsterProperties));
